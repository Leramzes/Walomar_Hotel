...
@WebServlet(name = "checkreservationstyperoom", urlPatterns = {"/checkreservationstyperoom"})
public class CheckReservationByTypeRoom extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        int typeRoomId = Integer.parseInt(req.getParameter("id"));
        boolean result = GestionTypeRoom.hasUpcomingReservations(typeRoomId);
