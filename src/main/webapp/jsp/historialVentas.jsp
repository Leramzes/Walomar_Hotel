...
<div class="d-flex justify-content-between align-items-center">
    <h4><i class="fa-solid fa-sheet-plastic me-2"></i> Historial de Ventas</h4>
...
<div class="d-flex justify-content-between text-center px-5 mt-6">
    <div>
        <h5>S/.500</h5>
